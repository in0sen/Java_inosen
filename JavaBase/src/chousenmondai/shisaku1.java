...
public class shisaku1 {
	...
	if(z==12311) {
		System.out.println(x+"Aさん"+y);
	}
	
	if(z==22121) {
		System.out.println(x+"Bさん"+y);
	}
	
	if(z==12211) {
		System.out.println(x+"Cさん"+y);
	}
	
	if(z==21122) {
		System.out.println(x+"Dさん"+y);
	}
	
	if(z==11122) {
		System.out.println(x+"Eさん"+y);
	}
	
	if(z==22212) {
		System.out.println(x+"Fさん"+y);
	}
